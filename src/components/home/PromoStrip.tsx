  ...
  return (
    <section className="container-px py-10">
      <div className="grid gap-5 md:grid-cols-2">
        <Reveal>
          <article className="flex h-full flex-wrap items-start gap-5 rounded-3xl border border-line bg-soft p-6 transition-colors hover:border-accent sm:flex-nowrap sm:items-center">
            ...
            <Link href="/productos" className="shrink-0 whitespace-nowrap text-sm font-bold text-accentDeep">
              Ver ofertas →
            </Link>
          </article>
        </Reveal>
        <Reveal delay={100}>
          <article className="flex flex-wrap items-start gap-5 rounded-3xl border border-line bg-soft p-6 transition-colors hover:border-accent sm:flex-nowrap sm:items-center">
            ...
            <Link href="/#beneficios" className="shrink-0 whitespace-nowrap text-sm font-bold text-accentDeep">
              Ver más →
            </Link>
          </article>
        </Reveal>
