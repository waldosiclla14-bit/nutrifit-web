          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-3 text-sm text-white/70">
                Escríbenos por WhatsApp y recibe tu cupón de 10% OFF al instante. También te
                avisamos de ofertas exclusivas y nuevos lanzamientos.
              </p>
            </div>
            <div className="flex flex-col items-start gap-3">
              <button
                ...
                onClick={() =>
                  openWhatsApp(
                    ...
                    'Hola NutriFit! Quiero mi cupón de 10% OFF 😊',
                  )
                }
              ...
              <p className="text-xs text-white/50">
                Respuesta directa por WhatsApp · Sin spam
              </p>
            </div>
          </div>
        </div>
