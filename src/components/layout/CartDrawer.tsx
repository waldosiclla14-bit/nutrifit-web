...
function ShoppingBagEmpty() {
  return (
    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-soft">
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted" role="img" aria-label="Carrito vacío">
