...
const PRODUCT_RAW: ProductRaw[] = [
  {
    id: 4,
    name: 'FullEnergic 100% Whey Protein 1kg',
    brand: 'FullEnergic',
    category: 'proteinas',
    ...
    ingredientes: ['100% Whey Protein (concentrado de proteína de suero de leche)', 'Saborizante natural', 'Sin azúcares añadidos', 'Libre de gluten'],
    goal: ['ganancia-muscular', 'rendimiento'],
    tags: ['whey', 'proteina', '1kg', 'fullenergic', 'suero', 'vainilla', 'frutilla', 'galleta', 'chocolate', 'manjar'],
    bestseller: true,
    variants: [
      { name: 'Vainilla', image: '/img/producto1.webp', stock: 7, rating: 4.9, reviews: 132 },
      { name: 'Frutilla', image: '/img/producto2.jpg', stock: 20, rating: 4.8, reviews: 98 },
      { name: 'Galleta', image: '/img/producto4.webp', stock: 22, rating: 4.9, reviews: 115 },
      { name: 'Chocolate', image: '/img/producto5.jpg', stock: 18, rating: 4.9, reviews: 140 },
      { name: 'Manjar', image: '/img/producto6.webp', stock: 18, rating: 4.9, reviews: 132 },
    ],
  },
  {
    id: 6,
    ...
    reviews: 88,
    badge: 'Oferta',
    image: '/img/FullEnergic 100% Vegan Protein Cookies & Cream 1kg.png',
  ...
  },
  {
    ...
    reviews: 156,
    badge: 'Oferta',
    image: '/img/creatina full energic 300g.png',
  ...
  },
  {
    ...
    reviews: 96,
    badge: 'Oferta',
    image: '/img/FNL Omega 3 Premium 800mg EPA  400mg DHA - 60 Cápsulas.png',
  ...
  },
  {
    ...
    reviews: 15,
    badge: 'Oferta',
    image: '/img/Rain TestoFull Ultra 180 Cápsulas.png',
  ...
  },
  {
    ...
    benefits: [
      ...
      'Efecto anabólico: ayuda a desarrollar masa muscular pura',
      'Efecto anticatabólico: previene la degradación muscular',
      'Fuente de energía de fácil obtención',
      'Apoyo a la regeneración corporal',
      'Apto para todas las disciplinas deportivas',
      'Recomendado durante el periodo de construcción de masa muscular',
    ],
    stock: 15,
    rating: 4.9,
    reviews: 0,
    ...
    modoUso: 'Consumir 1 servicio (aprox. 30 g) disuelto en 200–250 ml de agua fría o leche descremada. Tomar preferentemente justo después de entrenar o como snack entre comidas para completar tus requerimientos proteicos diarios.',
  ...
  {
    id: 37,
    name: 'Whey Protein FNL 947g Chocolate Suizo',
    brand: 'FNL',
    category: 'proteinas',
    categoryLabel: 'Proteínas',
    price: 45000,
    oldPrice: 48000,
    desc: 'Whey Protein FNL de 947 g sabor Chocolate Suizo. No contiene lactosa ni azúcar añadida. Aporta 24 g de proteína por porción y rinde 30 porciones por envase, ideal para recuperación, desarrollo muscular y dietas de pérdida de peso.',
    benefits: [
      'Mejora la recuperación post ejercicio',
      'Promueve el aumento de masa muscular y fuerza',
      'Previene la degradación y el catabolismo proteico',
      'Aporta sensación de saciedad',
      'Apoya el aumento del requerimiento proteico',
      'Apta para intolerantes a la lactosa por su enzima lactasa',
    ],
    stock: 15,
    rating: 4.9,
    reviews: 0,
    badge: 'Oferta',
    image: '/img/Whey Protein FNL 947g Chocolate Suizo.png',
    modoUso: 'Disolver 1 porción en 200–250 ml de agua fría o leche descremada, preferentemente justo después de entrenar o como refuerzo proteico durante el día.',
    nutrientes: [['Porciones por envase', '30'], ['Peso neto', '947 g'], ['Proteínas por porción', '24 g'], ['Lactosa', 'Apta para intolerantes (adición de lactasa)'], ['Azúcar añadida', 'Sin azúcar añadida']],
    ingredientes: ['Proteína de leche (concentrado de proteína de suero)', 'Lecitina de girasol', 'Fosfato de calcio', 'Sabor idéntico al natural', 'Lactasa', 'Sucralosa'],
    goal: ['ganancia-muscular', 'rendimiento', 'control-peso'],
    tags: ['whey', 'proteina', 'fnl', '947g', 'chocolate', 'chocolate-suizo', 'lactasa', 'sin-lactosa', 'sin-azucar', 'saciedad'],
    bestseller: true,
  },
];
...
export const PRODUCT_ALIASES: Record<string, string> = {
  'fullenergic-100-whey-protein-vainilla-1kg': 'fullenergic-100-whey-protein-1kg',
  'fullenergic-100-whey-protein-frutilla-1kg': 'fullenergic-100-whey-protein-1kg',
...
export const COMBOS: Combo[] = [
  ...
  },
  {
    ...
    items: ['FullEnergic 100% Whey Protein 1kg (Vainilla)', 'FullEnergic 100% Whey Protein 1kg (Frutilla)'],
    image: '/img/producto1.webp',
    price: 28000,
    oldPrice: 32000,
    tag: 'Ahorras $4.000',
...
export const TESTIMONIALS: Testimonial[] = [
  {
    name: 'Matías Rojas',
    role: 'Voy al gimnasio 4 veces por semana',
    rating: 5,
    text: 'La whey de vainilla de FullEnergic es la primera que se me disuelve bien solo con agua, sin grumos y sin ese sabor químico. Me la dejaron en la estación Los Leones al día siguiente de coordinar por WhatsApp.',
  },
  {
    name: 'Camila Fuentes',
    role: 'Hago CrossFit hace 2 años',
    rating: 5,
    text: 'La creatina es original, con su código de verificación en la lata. Llevo un mes usándola y noté más aguante en los WOD. Aparte, más barata que en las tiendas grandes.',
  },
  {
    name: 'Jorge Pizarro',
    role: 'Comprador recurrente',
    rating: 5,
    text: 'Pedí el pack de proteína + creatina en $27.500 y llegó todo bien sellado con sus precintos. La de frutilla es buenísima, ya le pasé el dato a mi hermano.',
  },
  {
    name: 'Daniela Soto',
    role: 'Hago yoga y pilates',
    rating: 5,
    text: 'El magnesio me ayudó caleta a dormir, no cachaba que era eso hasta que me lo recomendaron. La atención por WhatsApp fue súper rápida y me lo dejaron en Tobalaba.',
  },
  {
    name: 'Sebastián Muñoz',
    role: 'Entreno fuerza',
    rating: 5,
    text: 'Llevo 3 semanas con la creatina y la diferencia se nota en las últimas series. Tienda seria: me mandaron foto del producto antes de coordinar la entrega.',
  },
  {
    name: 'Valentina Cortés',
    role: 'Primera compra',
    rating: 4,
    text: 'Todo llegó en orden y sellado. Solo una vez se atrasó un poco la entrega porque me quedaba lejos de la estación, pero me la llevaron igual. Buena atención.',
  },
];
